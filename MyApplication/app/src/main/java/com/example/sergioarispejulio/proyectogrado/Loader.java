...
public class Loader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        System.out.println("---------------------------------------------------------------------------------");
        System.out.println(isPlayServicesInstalled());
        Intent i = new Intent(this, RegistrationService.class);
        startService(i);
        System.out.println("---------------------------------------------------------------------------------");
        se_verifico_token = false;
        singleton.getInstance().resetear_lista_postulaciones();
        singleton.getInstance().resetear_lista_trabajos();
        singleton.getInstance().resetear_lista_tipos_de_trabajo();
    ...
    public String getDeviceIDForGCM()
    {
        ...
        try {
            ...
            token = gcmTokenistanceID.getToken(
            ...
            try {
                if(se_conecto == true) {
                    ...
                    for (int i = 0; i < array.length(); i++) {
                        ...
                        System.out.println(solicitud.precio_medio);
